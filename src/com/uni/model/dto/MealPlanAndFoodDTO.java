...
public class MealPlanAndFoodDTO implements Serializable{
	...
	public String toString() {
		return mpDate + "\n\t breakfast1="
				+ breakfast1 + ", breakfast2=" + breakfast2 + ", breakfast3=" + breakfast3 + ", breakfast4="
				+ breakfast4 + ", breakfast5=" + breakfast5 + ", breakfast6=" + breakfast6 + "\n\t lunch1=" + lunch1
				+ ", lunch2=" + lunch2 + ", lunch3=" + lunch3 + ", lunch4=" + lunch4 + ", lunch5=" + lunch5

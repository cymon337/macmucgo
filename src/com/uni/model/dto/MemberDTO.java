...
public class MemberDTO {
	...
	private Date regDate;//sql date 기본형태 yyyy-MM-dd
	private String status;
	private String managerYN;
	
	public MemberDTO() {}

	public MemberDTO(int userNo, String userID, String userPwd, String userName, String phone, String height,
			String weight, String gender, Date regDate, String status, String managerYN) {
		super();
		this.userNo = userNo;
		this.userID = userID;
